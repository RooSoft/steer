defmodule SteerWeb.AttemptsLive do
  ...
  defp prepend_attempt(socket, htlc_id) do
    [attempt] =
      Steer.Lightning.get_htlc_forwards_with_statuses(
        from_forward_htlc_id: htlc_id,
        limit: 1
      )
